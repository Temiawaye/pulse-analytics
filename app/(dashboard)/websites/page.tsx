      ...
      <section className="mt-8 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
        <div className="flex items-center gap-3">
          <span className="grid size-9 place-items-center rounded-lg bg-emerald-100 text-emerald-800">
            <Icon aria-hidden="true" className="size-5" icon={addCircleIcon} />
          </span>
          <div>
            ...
            return (
              ...
              >
                ...
                <div className="mt-5 flex gap-2">
                  ...
                  <div className="rounded-full border border-slate-300 px-4 py-2 text-center text-sm font-semibold text-slate-700 hover:bg-slate-50">
                    <Link href={`/docs?website=${website.id}`}>Connect</Link>
                  </div>
                </div>
              </article>
            );
